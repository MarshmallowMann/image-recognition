...
class SignIn extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://secure-oasis-38797.herokuapp.com/signin',{
            method: "post",
    ...
    render() {
        return (
            <div>
                <h1 className="center f-headline mt0 white grow cursor" onClick={()=>this.props.onRouteChange("signin")}>Face Detector</h1>
                        ...
                        <div className="measure ">
                            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                                ...
                                <div className="mt3">
                                    ...
                                    <input className="pa2 input-reset ba bg-transparent hover-bg-black-40 hover-white w-100"
                                           type="email" name="email-address" id="email-address" onChange={this.onEmailChange}/>
                                </div>
                                <div className="mv3">
                                    <label className="db fw6 lh-copy f6" htmlFor="password">Password</label>
                                    <input className="b pa2 input-reset ba bg-transparent hover-bg-black-40 hover-white w-100"
